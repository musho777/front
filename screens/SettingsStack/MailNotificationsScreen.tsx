...
function MailNotificationsScreen({ navigation }: any) {
    ...
    const secondText = getStringInCurrentLanguage('Новые анкеты с моего города', 'New profiles from my city', 'Şehrimden yeni profiller', "Mening shahrimdan yangi profillar")
    const thirdText = getStringInCurrentLanguage('Новые комментарии', 'New comments', 'Yeni yorumlar', "Yangi izohlar")
...
export default MailNotificationsScreen
