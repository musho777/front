...
import { setName } from '../../store/ducks/auth/actionCreators'
...
function ChangeNameScreen({ navigation }: any) {
    ...
    const newNameText = getStringInCurrentLanguage('Новое имя пользователя:', 'New name:', 'Yeni kullanıcı adı:', "Yangi foydalanuvchi nomi:")

    const handleChangeName = () => {
        getToken().then(t => ApiRequests.updateUser(t, { fullName: newName }).then(d => {
